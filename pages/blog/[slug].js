      ...
      <>
        <Head>
          ...
          <link
            rel="icon"
            type="image/png"
            href="https://i.postimg.cc/SQZsdR2J/praveen-official.jpg"
          />
              ...
              <div class="">
                ...
                <div class="flex items-center pt-5 md:pt-10">
                  <div>
                    ...
                    <img
                      src="https://i.ibb.co/1GBDGj2/praveen-official.jpg"
              ...
              <div class="flex flex-col items-center border-t border-lila py-12 pt-12 md:flex-row md:items-start xl:pb-20">
                ...
                <div class="ml-0 text-center md:ml-10 md:w-5/6 md:text-left">
                  ...
                  <p class="pt-5 font-body text-lg leading-8 text-secondary sm:leading-9 md:text-xl md:leading-9 lg:leading-9 xl:leading-9">
                    ...
                    <br />
                    Thank You very much for coming here and reading my blog.
                    <br />
                    If you want to say something to me connect me on these
                    following links or you can directly send your respose by
                    filling the form which is present below.
                    <br />
                    Thanks again.. I hope that this blog will help you.
                  </p>
        ...
        <div class="bg-primary">
          <div class="container flex flex-col justify-between py-6 sm:flex-row">
            <p class="text-center font-body text-white md:text-left">
              © Copyright 2022. All right reserved, Praveen.
            </p>
            <div class="flex items-center justify-center pt-5 sm:justify-start sm:pt-0">
              {/* <a href="/">
            <i class="bx bxl-facebook-square text-2xl text-white hover:text-yellow"></i>
          </a> */}
              <a href="https://twitter.com/sha0urya2" class="pl-4">
                <i class="bx bxl-twitter text-2xl text-white hover:text-yellow"></i>
              </a>
              <a href="https://in.linkedin.com/in/sha0urya" class="pl-4">
                <i class="bx bxl-linkedin text-2xl text-white hover:text-yellow"></i>
              </a>
              <a href="https://www.instagram.com/sha0urya/" class="pl-4">
